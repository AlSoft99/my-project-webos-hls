Ext.onReady(function() {
	...
	var tree_role = new Ext.tree.TreePanel({
		...
		loader : new Ext.tree.TreeLoader({
			...
			baseParams :{
				parent: "select new map(a.id as id,a.id || '[' || b.paramsname || ']' as text,b.paramsname as qtip,a.recuser as recuser) from StoreOutputInfo a,ParamsList b where b.typeid='STORE_STATUS' and b.paramscode=a.status and outdate>'{1}' and outdate<'{2}' and recuser='"+document.getElementById("user_id").value+"'",
...
//	propertySource = {姓名:'官建明',工作天数:'6',基本工资:'20000.0',上岗工资:'30000.0',福利补贴:'1000.0',个人所得税:'2000.0',公积金:'2200.0',养老保险金:'2400.0',医疗保险金:'2600.0',综合保险金:'1000.0',其他福利保险:'0.0'};
	...
	new Ext.Panel({
        ...
        collapsible:true,
        hideBorders:true,
        renderTo: 'store_confirm_query_name',
        width : 350,
        height : height-100,
        items:[
        	tree_role,
    ...
    new Ext.Panel({
        ...
        collapsible:true,
        width : width-595,
        renderTo: 'store_confirm_query_list',
        height : height-100,
        items:[grid]
    });
