...
//            pageSize: 200,
    ...
    var listenerEvent = {
    	loadGrid:function(){
    		store.baseParams.sql = "select new map(sum(a.goodsnumber) as outnumber,b.goodsname as goodsname) from StoreOutputList a,StoreList b,StoreOutputInfo c where a.goodsid=b.id and a.outid=c.id and a.updttime>'{1}' and a.updttime<'{2}' and c.recuser='"+Ext.getDom("user_id").value+"' "+where+" group by a.goodsid,b.goodsname";
