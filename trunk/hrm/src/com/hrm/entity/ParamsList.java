...
public class ParamsList implements java.io.Serializable {
	...
	/** minimal constructor */
	public ParamsList(String id, Date updttime) {
		this.id = id;
		this.updttime = updttime;
	}

	/** full constructor */
	public ParamsList(String id, String typeid, String paramscode,
