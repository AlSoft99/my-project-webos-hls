...
<div id="dialog-register" style="display: none;" title="<span style='padding:3px 0;float:left;'>注册</span>">
	<form style="margin-top: 15px;">
		<table style="width:100%;">
			<tr>
				<td style="width:90px;">邮箱</td><td><input type="text" class="ui-input"  validate="varchar" isnull=true maxlength="100" minlength="0" defaultMsg="输入邮箱" style="width: 380px;"></td>
			</tr>
			<tr>
				<td style="width:90px;">姓名</td><td><input type="text" class="ui-input" defaultMsg="输入用户姓名" style="width: 380px;"></td>
			</tr>
			<tr>
				<td style="width:90px;">密码</td><td><input type="text" class="ui-input" defaultMsg="输入密码" style="width: 380px;"></td>
			</tr>
			<tr>
				<td style="width:90px;">确认密码</td><td><input type="text" class="ui-input" defaultMsg="输入确认密码" style="width: 380px;"></td>
			</tr>
		</table>
	</form>
</div>
