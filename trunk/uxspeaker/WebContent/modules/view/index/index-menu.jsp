...
<div id="dialog-register" style="display: none;" title="<span style='padding:3px 0;float:left;'>注册</span>">
	<form style="margin-top: 15px;">
		<table style="width:100%;">
			...
			<tr>
				<td style="width:90px;">确认密码</td><td><input type="text" class="ui-input" id="con-password" confirm="password" validate="password" isnull=true maxlength="20" minlength="0" placeholder="输入确认密码" style="width: 380px;"></td>
			</tr>
		</table>
	</form>
</div>
<div id="dialog-login" style="display: none;" title="<span style='padding:3px 0;float:left;'>登陆</span>">
	<form style="margin-top: 15px;">
		<table style="width:100%;">
			...
			<tr>
				<td style="width:90px;">密码</td><td><input type="text" class="ui-input" id="password" name="password" validate="password" isnull=true maxlength="20" minlength="0" placeholder="输入密码" style="width: 380px;"></td>
			</tr>
		</table>
	</form>
</div>
