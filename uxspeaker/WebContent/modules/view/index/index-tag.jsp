...
List<Map<String,Object>> list = queryType.queryByPage("SQL6", " and d.tagname='"+tagnameTmp+"' ",(Integer.parseInt(currentPage)-1)*rownumber,rownumber);
//List<Map<String,Object>> list = dao.queryArticleMap((Integer.parseInt(currentPage)-1)*rownumber,rownumber);
int count = (int)queryType.getCount("SQL6", " and d.tagname='"+tagnameTmp+"'");
String atricleType = "";
if(count==0){
	atricleType = "暂无文章";
}else{
	atricleType = tagnameTmp;
}
%>
...
<!-- JavaScripts-->
<script type="text/javascript" src="modules/script/index/index-tag.js"></script>
</head>
<body>
	...
	<div class="index-body" id="index" total="<%=count%>" currentPage="<%=currentPage%>" rownumber="<%=rownumber%>" tagname="<%=tagnameTmp%>">
