...
$("#yoxview_popupWrap div,#yoxview_popupWrap a,#yoxview_popupWrap img").each(function(){
	if(typeof($(this).attr("classname"))!="undefined"){
		$(this).addClass($(this).attr("classname"));
	}
});
return this};b(Yox.getTopWindow()).unload(function(){if(b.yoxview){b.yoxview.unload();delete b.yoxview}})})(jQuery);